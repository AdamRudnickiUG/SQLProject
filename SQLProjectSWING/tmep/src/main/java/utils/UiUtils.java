...
public class UiUtils {
    ...
    public void minMaxPref(Component component, int width, int height) {
    ...
    public void minMaxPrefWidth(Component component, int width) {
    ...
    public void minMaxPrefHeight(Component component, int height) {
    ...
    public void border(Component component, Color color, int top, int left, int bottom, int right) {
